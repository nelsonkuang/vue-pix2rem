  ...
  <article class="pageview">
    ...
    <section class="main">
      ...
      <div :style="{textAlign:'center', marginTop:'20px'}">
        <button class="btn" @click="getCurrentAddress">点击更新到下面当前填写地址信息</button>
        <button class="btn" style="margin-left: 20px;" @click="updateCurrentAddress" :disabled="updating">{{updateBtnText}}</button>
      </div>
      ...
      <!--加载中-->
      <div class="spinner spinner-gritcode spinner-md" v-if="loading">
